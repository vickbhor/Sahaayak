...
*   **🚨 Critical Case Flagging:** High-risk symptom combinations immediately trigger warnings to seek in-person emergency care.
...
| Method | Endpoint | Description |
| :--- | :--- | :--- |
| `POST` | `/api/triage` | Submit a chat message or generate a final triage report |
