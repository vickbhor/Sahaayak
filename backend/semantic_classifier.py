...
from groq_helpers import verify_prediction_with_groq
...
class SemanticMedicalClassifier:
    ...
    async def predict(self, extracted_symptoms: str) -> dict:
        ...
        try:
            ...
            hits = res["hits"]["hits"]
            if not hits:
                return {"predicted_disease": "Unknown Condition", "urgency": "LOW", "specialist": "General Physician", "confidence": 0.0}
